...
#ifndef TEXTTOSPEECHPLUGIN_SWIFT_H
#define TEXTTOSPEECHPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TextToSpeechPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class CAPPluginCall;
SWIFT_CLASS("_TtC18TextToSpeechPlugin12TextToSpeech")
...
@interface TextToSpeechPlugin : CAPPlugin <CAPBridgedPlugin>
